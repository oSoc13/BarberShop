	...
	?>
		...
		<div class = "maindiv">
			...
			<?php
				...
				{
					echo "<div onclick= loadPhoto('". $row["id"] . "')>" . $row["username"] . "</div>";
				}
				$temp = "img_".$row["id"];
				echo '<div class="imgitem" id = '. $temp .' style=display:none><a href="images/full/' . $row['image'] . '"><img width="200" height="200" src="images/thumb/' . $row['image'] . ' " alt="Hair" /></a></div><br />' ;
				}
